...
<body>
    <div class="container mx-auto p-4">
        <h1 class="text-center text-red-800 text-3xl font-bold my-4">All Students Data</h1>
        <div class="overflow-x-auto">
            <table class="min-w-full bg-white border rounded-lg border-gray-200">
                <thead>
                    <tr class="bg-red-700 text-xl text-white">
                ...
                <tbody>
                    ...
                    <tr class="text-center border-red-200 border-b-2 bg-red-50 text-xl p-5">
