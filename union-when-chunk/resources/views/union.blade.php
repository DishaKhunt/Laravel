...
<body>
    <div class="container mx-auto p-4">
        <h1 class="text-center text-3xl font-bold my-4 text-pink-800">All Students Data</h1>
        <div class="overflow-x-auto">
            <table class="min-w-full bg-white border rounded-lg border-gray-200">
                <thead>
                    <tr class="bg-pink-700 text-xl text-white">
                        ...
                        <th class="py-4 px-4 border-b">City_name</th>
                        
                    </tr>
                </thead>
                <tbody>
                    @foreach ($students as $data)
                    <tr class="text-center border-pink-200 border-b-2 bg-pink-100 text-xl p-5">
